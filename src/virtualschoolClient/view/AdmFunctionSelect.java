...
public class AdmFunctionSelect {
...
//			public void run() {
//				try {
//					AdmFunctionSelect window = new AdmFunctionSelect(user,cs);
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
//				
...
//		});
	 ...
	 */
	public AdmFunctionSelect(User user,ClientSocket cs,JFrame frame) {
	...
	private void initialize() {
		...
		checkCourse.setBounds(143, 104, 121, 31);
		...
		checkCurriculum.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panelFunSel.setVisible(false);
				AdmCurriculumCheck frame=new AdmCurriculumCheck(user,cs,frameFunSel);
			}
		});
		checkCurriculum.setBounds(143, 159, 121, 31);
		panelFunSel.add(checkCurriculum);
